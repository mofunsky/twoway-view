...
public class RecyclerViewEx extends ViewGroup {
    ...
    /**
     * Set the {@link LayoutManager} that this RecyclerViewEx will use.
     *
     * <p>In contrast to other adapter-backed views such as {@link android.widget.ListView}
     * or {@link android.widget.GridView}, RecyclerViewEx allows client code to provide custom
     * layout arrangements for child views. These arrangements are controlled by the
     * {@link LayoutManager}. A LayoutManager must be provided for RecyclerViewEx to function.</p>
     *
    ...
    /**
     * Retrieve this RecyclerViewEx's {@link RecycledViewPool}. This method will never return null;
    ...
    /**
     * Add an {@link ItemDecoration} to this RecyclerViewEx. Item decorations can
    ...
    /**
     * Remove an {@link ItemDecoration} from this RecyclerViewEx.
     *
     ...
     * {@link LayoutManager#smoothScrollToPosition(android.support.v7.widget.RecyclerViewEx, State, int)} and create a
     * {@link SmoothScroller}.
     * <p>
     * {@link LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link LayoutManager#smoothScrollToPosition(android.support.v7.widget.RecyclerViewEx, State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see LayoutManager#smoothScrollToPosition(android.support.v7.widget.RecyclerViewEx, State, int)
     */
     ...
     * returns true from
     * {@link OnItemTouchListener#onInterceptTouchEvent(android.support.v7.widget.RecyclerViewEx, android.view.MotionEvent)} its
     * {@link OnItemTouchListener#onTouchEvent(android.support.v7.widget.RecyclerViewEx, android.view.MotionEvent)} method will be called
...
//                mDuration = mSplineDuration = getSplineFlingDuration(velocity);
     ...
     * and use {@link android.support.v7.widget.RecyclerViewEx#setRecycledViewPool(RecycledViewPool)}.
     * <p>
    ...
    public final class Recycler {
         ...
         * {@link Adapter#onCreateViewHolder(android.view.ViewGroup, int)}.
         * <p>
         ...
         * @see LayoutManager#removeAndRecycleView(android.view.View, Recycler)
         */
    ...
    public abstract static class ViewCacheExtension {
         ...
         * {@link LayoutManager#stopIgnoringView(android.view.View)} before returning the View.
         * <p>
         ...
         * @see LayoutManager#ignoreView(android.view.View)
         */
     ...
     * within a {@link android.support.v7.widget.RecyclerViewEx}.</p>
     */
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        /**
         * Called when RecyclerViewEx needs a new {@link ViewHolder} of the given type to represent
         * an item.
         * <p>
         ...
         * {@link ViewHolder} and initializes some private fields to be used by RecyclerViewEx.
         *
         ...
         * needs to be attached to its parent {@link android.support.v7.widget.RecyclerViewEx}. This can be because it has
         ...
         * @see #onDetachedFromRecyclerView(android.support.v7.widget.RecyclerViewEx)
         */
         ...
         * @see #onAttachedToRecyclerView(android.support.v7.widget.RecyclerViewEx)
         */
    ...
    public static abstract class LayoutManager {
         ...
         * {@link android.support.v7.widget.RecyclerViewEx#setItemAnimator(ItemAnimator) ItemAnimator} set on the
        ...
        /**
         * @deprecated
         * override {@link #onDetachedFromWindow(android.support.v7.widget.RecyclerViewEx, Recycler)}
         */
        @Deprecated
        ...
        /**
         * @deprecated Use {@link #onRequestChildFocus(android.support.v7.widget.RecyclerViewEx, State, android.view.View, android.view.View)}
         */
        @Deprecated
         ...
         *
         * <p>Read {@link android.support.v7.widget.RecyclerViewEx#computeHorizontalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerViewEx
         * @return The horizontal extent of the scrollbar's thumb
         * @see android.support.v7.widget.RecyclerViewEx#computeHorizontalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link android.support.v7.widget.RecyclerViewEx#computeHorizontalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerViewEx where you can find total item count
         * @return The horizontal offset of the scrollbar's thumb
         * @see android.support.v7.widget.RecyclerViewEx#computeHorizontalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link android.support.v7.widget.RecyclerViewEx#computeHorizontalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerViewEx where you can find total item count
         * @return The total horizontal range represented by the vertical scrollbar
         * @see android.support.v7.widget.RecyclerViewEx#computeHorizontalScrollRange()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link android.support.v7.widget.RecyclerViewEx#computeVerticalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerViewEx
         * @return The vertical extent of the scrollbar's thumb
         * @see android.support.v7.widget.RecyclerViewEx#computeVerticalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link android.support.v7.widget.RecyclerViewEx#computeVerticalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerViewEx where you can find total item count
         * @return The vertical offset of the scrollbar's thumb
         * @see android.support.v7.widget.RecyclerViewEx#computeVerticalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link android.support.v7.widget.RecyclerViewEx#computeVerticalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerViewEx where you can find total item count
         * @return The total vertical range represented by the vertical scrollbar
         * @see android.support.v7.widget.RecyclerViewEx#computeVerticalScrollRange()
         */
         ...
         * @see #removeAndRecycleView(android.view.View, Recycler)
         ...
         * at all. For example, if there is not any {@link ItemAnimator} set, RecyclerViewEx will
     ...
     * views (in {@link ItemDecoration#onDraw(android.graphics.Canvas, android.support.v7.widget.RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State) onDraw()}
     * and after the items (in {@link ItemDecoration#onDrawOver(android.graphics.Canvas, android.support.v7.widget.RecyclerViewEx,
    ...
    public static abstract class ItemDecoration {
        ...
        /**
         * @deprecated
         * Override {@link #onDraw(android.graphics.Canvas, android.support.v7.widget.RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State)}
         */
        @Deprecated
        ...
        /**
         * @deprecated
         * Override {@link #onDrawOver(android.graphics.Canvas, android.support.v7.widget.RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State)}
         */
        @Deprecated
        ...
        /**
         * @deprecated
         * Use {@link #getItemOffsets(android.graphics.Rect, android.view.View, android.support.v7.widget.RecyclerViewEx, State)}
         */
        @Deprecated
     ...
     *
     * @see android.support.v7.widget.RecyclerViewEx#setOnScrollListener(OnScrollListener)
     */
     ...
     * a view is recycled.
     *
     * @see android.support.v7.widget.RecyclerViewEx#setRecyclerListener(RecyclerListener)
     */
    ...
    public static abstract class ViewHolder {
         ...
         *
         * @return The the item's id if adapter has stable ids, {@link android.support.v7.widget.RecyclerViewEx#NO_ID}
         * otherwise
         */
     ...
     * {@link android.support.v7.widget.RecyclerViewEx}. Custom {@link LayoutManager layout managers} are encouraged
    ...
    public static abstract class SmoothScroller {
         ...
         * <p>In each animation step, {@link android.support.v7.widget.RecyclerViewEx} will check
         * for the target view and call either
         * {@link #onTargetFound(android.view.View, android.support.v7.widget.RecyclerViewEx.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, android.support.v7.widget.RecyclerViewEx.State, SmoothScroller.Action)} until
         ...
         * {@link #onTargetFound(android.view.View, android.support.v7.widget.RecyclerViewEx.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, android.support.v7.widget.RecyclerViewEx.State, SmoothScroller.Action)}.
         */
         ...
         * {@link android.support.v7.widget.RecyclerViewEx#NO_POSITION} if no target view is set.
         */
        ...
        /**
         * @see android.support.v7.widget.RecyclerViewEx#getChildPosition(android.view.View)
         */
        ...
        /**
         * @see android.support.v7.widget.RecyclerViewEx#scrollToPosition(int)
         */
    ...
    public static class State {
         ...
         * {@link android.support.v7.widget.RecyclerViewEx#NO_POSITION} if there is no target
         * position.
         */
         ...
         * scenes, RecyclerViewEx offsets {@link Recycler#getViewForPosition(int)} calls such that
